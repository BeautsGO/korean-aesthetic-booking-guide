...
In the search bar, type 中文名"blancjou" to find blancjou.
...
Type 中文名"blancjou" in the search bar to find blancjou.
...
Tap [Book Now] in the menu and enter 中文名"blancjou" ⚡.
...
Enter 中文名"blancjou" in the search bar to find blancjou.
