...
In the search bar, type 中文名"mylog" to find mylog.
...
Type 中文名"mylog" in the search bar to find mylog.
...
Tap [Book Now] in the menu and enter 中文名"mylog" ⚡.
...
Enter 中文名"mylog" in the search bar to find mylog.
