...
In the search bar, type 中文名"afternoon" to find afternoon.
...
Type 中文名"afternoon" in the search bar to find afternoon.
...
Tap [Book Now] in the menu and enter 中文名"afternoon" ⚡.
...
Enter 中文名"afternoon" in the search bar to find afternoon.
