...
In the search bar, type 中文名"BeautsGO" to find BeautsGO.
...
Type 中文名"BeautsGO" in the search bar to find BeautsGO.
...
Tap [Book Now] in the menu and enter 中文名"BeautsGO" ⚡.
...
Enter 中文名"BeautsGO" in the search bar to find BeautsGO.
