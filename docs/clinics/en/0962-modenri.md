...
In the search bar, type 中文名"Modenri" to find Modenri.
...
Type 中文名"Modenri" in the search bar to find Modenri.
...
Tap [Book Now] in the menu and enter 中文名"Modenri" ⚡.
...
Enter 中文名"Modenri" in the search bar to find Modenri.
