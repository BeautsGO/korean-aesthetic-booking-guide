...
In the search bar, type 中文名"MIN CLINIC"、英文名"min"、拼音"MINCLINIC" to find MIN CLINIC.
...
Type 中文名"MIN CLINIC"、英文名"min"、拼音"MINCLINIC" in the search bar to find MIN CLINIC.
...
Tap [Book Now] in the menu and enter 中文名"MIN CLINIC"、英文名"min"、拼音"MINCLINIC" ⚡.
...
Enter 中文名"MIN CLINIC"、英文名"min"、拼音"MINCLINIC" in the search bar to find MIN CLINIC.
