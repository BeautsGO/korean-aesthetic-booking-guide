...
In the search bar, type 中文名"ID"、拼音"IDyiyuan"、首字母"IDyy" to find ID医院.
...
Type 中文名"ID"、拼音"IDyiyuan"、首字母"IDyy" in the search bar to find ID医院.
...
Tap [Book Now] in the menu and enter 中文名"ID"、拼音"IDyiyuan"、首字母"IDyy" ⚡.
...
Enter 中文名"ID"、拼音"IDyiyuan"、首字母"IDyy" in the search bar to find ID医院.
