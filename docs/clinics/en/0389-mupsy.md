...
In the search bar, type 中文名"MUPSY"、英文名"mup_sy" to find MUPSY.
...
Type 中文名"MUPSY"、英文名"mup_sy" in the search bar to find MUPSY.
...
Tap [Book Now] in the menu and enter 中文名"MUPSY"、英文名"mup_sy" ⚡.
...
Enter 中文名"MUPSY"、英文名"mup_sy" in the search bar to find MUPSY.
