...
In the search bar, type 中文名"Voc Spa"、拼音"VocSpa" to find Voc Spa.
...
Type 中文名"Voc Spa"、拼音"VocSpa" in the search bar to find Voc Spa.
...
Tap [Book Now] in the menu and enter 中文名"Voc Spa"、拼音"VocSpa" ⚡.
...
Enter 中文名"Voc Spa"、拼音"VocSpa" in the search bar to find Voc Spa.
