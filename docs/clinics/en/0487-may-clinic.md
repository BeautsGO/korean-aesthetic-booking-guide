...
In the search bar, type 中文名"may clinic"、拼音"mayclinic" to find may clinic.
...
Type 中文名"may clinic"、拼音"mayclinic" in the search bar to find may clinic.
...
Tap [Book Now] in the menu and enter 中文名"may clinic"、拼音"mayclinic" ⚡.
...
Enter 中文名"may clinic"、拼音"mayclinic" in the search bar to find may clinic.
